<?php
	...
	if (!function_exists('idn_to_utf8')) {
	    ...
	    require_once DOCROOT . '/symphony/lib/boot/idna.php';

		$idn = new idna_convert();

		define('DOMAIN', $idn->decode(rtrim(rtrim($_SERVER['HTTP_HOST'], '\\/') . DOMAIN_PATH, '\\/')));

	} else {

		define('DOMAIN', idn_to_utf8(rtrim(rtrim($_SERVER['HTTP_HOST'], '\\/') . DOMAIN_PATH, '\\/')));
	}
