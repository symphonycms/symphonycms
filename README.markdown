...
- Version: 2.3.4 Release Candidate 1
- Date: 7th October 2013
- Release Notes: <http://getsymphony.com/download/releases/version/2.3.4/>
- Github Repository: <http://github.com/symphonycms/symphony-2/tree/2.3.4RC1>
...
Symphony is a `PHP` & `MySQL` based CMS that utilises `XML` and `XSLT` as its core technologies. This repository represents version `2.3.4 Release Candidate 1` and is considered stable.
