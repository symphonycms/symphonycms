...
- Version: 2.3.5 Release Candidate 1
- Date: 3rd January 2014
- Release Notes: <http://getsymphony.com/download/releases/version/2.3.5/>
- Github Repository: <http://github.com/symphonycms/symphony-2/tree/2.3.5RC1>
...
Symphony is a `PHP` & `MySQL` based CMS that utilises `XML` and `XSLT` as its core technologies. This repository represents version `2.3.5 Release Candidate 1` and is considered stable.
