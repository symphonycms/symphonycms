...
- [Release notes](http://getsymphony.com/download/releases/version/2.6.5/)
- [Github repository](https://github.com/symphonycms/symphony-2/tree/2.6.5)
...
Symphony is a `PHP` & `MySQL` based CMS that utilises `XML` and `XSLT` as its core technologies. This repository represents version `2.6.5` and is considered stable.
