...
class Widget
{
     ...
     * @return XMLElement
     */
    public static function createFilteringDuplicator($section, $inputArray=null)
    {
        $div = new XMLElement('div');
        ...
        self::__createFieldFilters($ol, $section, $inputArray);
        self::__createSystemDateFilters($ol, $inputArray);

        $div->appendChild($ol);
        return $div;
    }

    private static function __createFieldFilters(&$wrapper, $section, $inputArray)
    {
        $filters = $_GET['filter'];
    ...
    private static function __createSystemDateFilters(&$wrapper, $inputArray)
    {
        $filters = $_GET['filter'];
