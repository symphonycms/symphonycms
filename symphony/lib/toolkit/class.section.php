<?php
    ...
    class Section
    {
        ...
        {
            return FieldManager::fetch(null, $this->get('id'), 'ASC', 'sortorder', null, null,
                " AND t1.show_column = 'yes' ");
        }
         ...
         *
         * @deprecated This function will be removed in Symphony 3.0.0. Use `fetchChildAssociations` instead.
        ...
        {
            return FieldManager::fetch(null, $this->get('id'), 'ASC', 'sortorder', null, $location, null,
                Field::__FILTERABLE_ONLY__);
        }
