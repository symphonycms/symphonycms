<?php
    ...
    class TextformatterManager implements FileResource
    {
        ...
        {
            $result = array();
            $structure = General::listStructure(TEXTFORMATTERS, '/formatter.[\\w-]+.php/', false, 'ASC',
                TEXTFORMATTERS);
            ...
            if (is_array($extensions) && !empty($extensions)) {
                foreach ($extensions as $e) {
                    ...
                    $tmp = General::listStructure(EXTENSIONS . "/$e/text-formatters", '/formatter.[\\w-]+.php/', false,
                        'ASC', EXTENSIONS . "/$e/text-formatters");
