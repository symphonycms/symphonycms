        ...
        public function __viewIndex($resource_type)
        {
            ...
            if (!is_array($resources) || empty($resources)) {
                ...
                foreach ($resources as $r) {
                    ...
                    $name->appendChild(Widget::Label(__('Select ' . $friendly_resource . ' %s', array($r['name'])),
                        null, 'accessible', null, array(
                    ...
                    } elseif (isset($r['source']) && class_exists($r['source']['name']) && method_exists($r['source']['name'],
                            'getSourceColumn')
                    ) {
