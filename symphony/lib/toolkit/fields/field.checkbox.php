<?php
    ...
    class FieldCheckbox extends Field implements ExportableField, ImportableField
    {
        ...
        public function displayPublishPanel(
            ...
            $input = Widget::Input('fields' . $fieldnamePrefix . '[' . $this->get('element_name') . ']' . $fieldnamePostfix,
                'yes', 'checkbox', ($value === 'yes' ? array('checked' => 'checked') : null));
        ...
        public function appendFormattedElement(
            ...
            $wrapper->appendChild(new XMLElement($this->get('element_name'),
        ...
        public function getExampleFormMarkup()
        {
            ...
            $label->appendChild(Widget::Input('fields[' . $this->get('element_name') . ']', 'yes', 'checkbox',
                ($this->get('default_state') === 'on' ? array('checked' => 'checked') : null)));
