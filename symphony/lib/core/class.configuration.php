<?php
	 ...
	 */
	  ...
	  * Symphony's configuration file is saved at <code>CONFIG</code>. The inital
	  * file is generated by the Symhony installer, and then subsequent use of Symphony
	...
	Class Configuration{
		...
		/**
		 * Setter for the <code>$this->_properties</code>. The properties array
		 * can be grouped to be an 'array' of an 'array' of properites. For instance
		 ...
		 * a combination of both, this will PHP's array_merge with <code>$this->_properties</code>
		 *
		 * @param array $array
		...
		/**
		 * Accessor function for the <code>$this->_properties</code>. If the
		 ...
		 * @return array|string
		 *  If <code>$name</code> or <code>$group</code> are not
		 *  provided this function willl return the full <code>$this->_properties</code>
		 *  array.
		 */
		...
		/**
		 * The remove function will unset a property by <code>$name</code>.
		 * It is possible to remove an entire 'group' by passing the group
		 * name as the <code>$name</code>
		 *
		 * @param string $name
		...
		/**
		 * Empties all the Configuration values by setting <code>$this->_properties</code>
		 * to an empty array
		 */
		...
		/**
		 * The magic __toString function converts the internal <code>$this->_properties</code>
		 ...
		 *
		 * @return string
		 *  A string that contains a PHP representation of <code>$this->_properties</code>.
