    ...
    Class SymphonyLoader {
        ...
        public static function init() {
            self::$classes = array(
                ...
                'container' => CORE . '/class.container.php',
                'configuration' => CORE . '/class.configuration.php',
                'cookies' => CORE . '/class.cookies.php',
                ...
                'databasesessionhandler' => CORE . '/class.databasesessionhandler.php',
                'session' => CORE . '/class.session.php',
                'sessionflash' => CORE . '/class.sessionflash.php',
