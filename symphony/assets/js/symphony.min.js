...
// Hide all choices
g.trigger("pickstart.pickable"),j.hide(),
// Selection found
c=a("#"+h),c.length>0?(c.show().trigger("pick.pickable"),g.trigger("pickstop.pickable")):(f=g.data("request"),
...
c.is(".instance")?b=c.find(".comparison").val():(b=c.val(),c=c.parents(".instance")),n(c,b)},k=function(){var a,c,d=l();
// Fetch entries
