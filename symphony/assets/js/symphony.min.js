...
// Collapse item
e.on("collapse.collapsible",f.items,function(b,c){b.stopPropagation();var d=a(this);i(d,h(c))}),
// Collapse all items
...
e.on("destructstop.duplicator",f.items,function(b){a(this).trigger("store.collapsible")}),
// Update sizes
e.on("updatesize.collapsible",f.items,function(b){var c=a(this),d=c.find(f.handles).outerHeight(!0),e=d+c.find(f.content).outerHeight(!0);c.data("heightMin",d),c.data("heightMax",e)}),
// Set sizes
e.on("setsize.collapsible",f.items,function(b){var c=a(this),d=c.data("heightMin"),e=c.data("heightMax");c.css({"min-height":d,"max-height":e})}),/*---------------------------------------------------------------------
			Initialisation
		---------------------------------------------------------------------*/
// Prepare interface
