...
a(window).on("resize.drawer load.drawer",function(){var a=i();d.filter(".vertical-left, .vertical-right").css("height",a)});/*-------------------------------------------------------------------------
		Utilities
	-------------------------------------------------------------------------*/
var i=function(){return Math.max(window.innerHeight-f[0].offsetTop-1,f[0].clientHeight)};/*-----------------------------------------------------------------------*/
/*-------------------------------------------------------------------------
		Initialisation
	-------------------------------------------------------------------------*/
...
b=c.is(":visible:first")?0:(c.prevAll().length+1)*c.outerHeight()-180,a.animate({scrollTop:b},150)};/*-------------------------------------------------------------------------
		API
	-------------------------------------------------------------------------*/
return{init:d}}()}(window.jQuery,window.Symphony),/**
...
// Calendars
a(".field-date").each(function(){var d,e=a(this),f=b.Context.get("datetime");
// Add calendar widget
e.attr("data-interactive")&&(d=new b.Interface.Calendar,d.init(this)),
// Add timezone offset information
c().utcOffset()!==f["timezone-offset"]&&e.addClass("show-timezone")})}),b.View.add("/:context*:/new",function(){b.Elements.contents.find('input[type="text"], textarea').first().focus()}),/*--------------------------------------------------------------------------
