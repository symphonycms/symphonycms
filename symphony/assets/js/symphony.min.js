...
// Hide all choices
g.trigger("pickstart.pickable"),j.hide().find("input, select, textarea").prop("readonly",!0),c=a("#"+h),c.length>0?(c.show().find("input, select, textarea").prop("readonly",!1).trigger("pick.pickable"),g.trigger("pickstop.pickable")):(f=g.data("request"),f&&a.ajax({type:"GET",url:f,data:{choice:h},dataType:"html",success:function(a){e.append(a),a.trigger("pick.pickable"),g.trigger("pickstop.pickable")}}))});/*-------------------------------------------------------------------------
		Initialisation
	-------------------------------------------------------------------------*/
var e=a(d.content);/*-----------------------------------------------------------------------*/
