<?php
	...
	Class contentBlueprintsComponents extends AdministrationPage{
		...
		function view(){
			...
			$h3->appendChild(Widget::Anchor(__('Create New'), URL . '/symphony/blueprints/events/new/', __('Create a new event'), 'create button', NULL, array('accesskey' => 'e')));
			$li->appendChild($h3);
			...
			$h3->appendChild(Widget::Anchor(__('Create New'), URL . '/symphony/blueprints/datasources/new/', __('Create a new data source'), 'create button', NULL, array('accesskey' => 'd')));
			$li->appendChild($h3);
			...
			$h3->appendChild(Widget::Anchor(__('Create New'), URL . '/symphony/blueprints/utilities/new/', __('Create a new utility'), 'create button', NULL, array('accesskey' => 'u')));
			$li->appendChild($h3);
