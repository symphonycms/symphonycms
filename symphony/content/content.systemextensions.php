        ...
        public function __viewIndex()
        {
            ...
            if (!is_array($extensions) || empty($extensions)) {
                ...
                foreach ($extensions as $name => $about) {
                    ...
                    $td1->appendChild(Widget::Label(__('Select %s Extension', array($about['name'])), null,
                    ...
                    if ($about['github'] !== '') {
                        $tdLinks['github'] = Widget::Anchor(__('GitHub'),
                            General::validateURL($about['github']))->generate();
                    }

                    if ($about['discuss'] !== '') {
                        $tdLinks['discuss'] = Widget::Anchor(__('Discuss'),
                            General::validateURL($about['discuss']))->generate();
                    ...
                    if ($about['homepage'] !== '') {
                        $tdLinks['homepage'] = Widget::Anchor(__('Homepage'),
                            General::validateURL($about['homepage']))->generate();
                    }
                    ...
                    if ($about['issues'] !== '') {
                        $tdLinks['issues'] = Widget::Anchor(__('Issues'),
                            General::validateURL($about['issues']))->generate();
                    }
                    ...
                    foreach ($about['author'] as $author) {
                        if (isset($author['website'])) {
                            $tdAuthors[] = Widget::Anchor($author['name'],
                                General::validateURL($author['website']))->generate();
                        } elseif (isset($author['github'])) {
                            $tdAuthors[] = Widget::Anchor($author['name'],
                                General::validateURL('https://github.com/' . $author['github']))->generate();
                ...
                try {
                    switch ($_POST['with-selected']) {
                        case 'enable':
                             ...
                             */
                            Symphony::ExtensionManager()->notifyMembers('ExtensionPreEnable', '/system/extensions/',
                                array('extensions' => &$checked));
                        ...
                        case 'disable':
                             ...
                             */
                            Symphony::ExtensionManager()->notifyMembers('ExtensionPreDisable', '/system/extensions/',
                                array('extensions' => &$checked));
                        ...
                        case 'uninstall':
                             ...
                             */
                            Symphony::ExtensionManager()->notifyMembers('ExtensionPreUninstall', '/system/extensions/',
                                array('extensions' => &$checked));
